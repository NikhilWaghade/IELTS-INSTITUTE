        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight tracking-tighter">
              Crack IELTS. Unlock Your Global Future.

            </h1>
            <p className="mt-6 text-lg text-gray-600 max-w-xl mx-auto md:mx-0">
              Step into your international journey with expert-led IELTS coaching, proven strategies, and personalized guidance to hit your dream band score.
